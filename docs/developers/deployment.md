...
That's it. Versions in `pyproject.toml`/`CHANGELOG.md` should already match the tag (see the Release Process section in [`AGENTS.md`](https://github.com/fgcz/qg/blob/main/AGENTS.md#release-process)).
