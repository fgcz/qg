...
@pytest.mark.parametrize(
    "technology,instrument,sampler,queue_pattern,expected_format",
    [
...
def test_simulate_params(configs, technology, instrument, sampler, queue_pattern, expected_format):
